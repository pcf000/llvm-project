// RUN: mlir-opt %s -pass-pipeline="builtin.module(func.func(tosa-to-linalg-named),func.func(tosa-to-linalg),tosa-to-tensor,tosa-to-arith,one-shot-bufferize{allow-return-allocs bufferize-function-boundaries},func.func(buffer-deallocation),func.func(convert-linalg-to-loops),lower-affine,convert-linalg-to-llvm,convert-scf-to-cf,convert-math-to-llvm,convert-memref-to-llvm,convert-func-to-llvm,reconcile-unrealized-casts)" \
...
// CHECK-NEXT:  [-0.399353
//
// RUN: mlir-opt %s -pass-pipeline="builtin.module(tosa-partition,func.func(tosa-to-linalg-named),func.func(tosa-to-linalg),tosa-to-tensor,tosa-to-arith,one-shot-bufferize{allow-return-allocs bufferize-function-boundaries},func.func(buffer-deallocation),func.func(convert-linalg-to-loops),lower-affine,convert-linalg-to-llvm,convert-scf-to-cf,convert-math-to-llvm,convert-memref-to-llvm,convert-func-to-llvm,reconcile-unrealized-casts)" \
// RUN: | mlir-cpu-runner -e main -entry-point-result=void \
// RUN:   -shared-libs=%mlir_lib_dir/libmlir_runner_utils%shlibext \
// RUN:   -shared-libs=%mlir_lib_dir/libmlir_c_runner_utils%shlibext \
// RUN: > %t2
