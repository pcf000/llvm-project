...
// generalised to include transpose and reshape ops and certain constant ops.)
//
//===----------------------------------------------------------------------===//
...
// The OutliningCandidate structure is designed to identify identical kernels
// as they're being gathered and before creating any.
...
// Given a convolution op and its fuse-able trailing and leading ops,
// remove them into a separate function.
